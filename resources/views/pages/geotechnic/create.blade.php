                        ...
                        <div class="card-body">
                            ...
                            <div class="col-sm-12"  style="padding-top: 20px;border: 1px;border-color: #0b0b0b">
                                ...
                                <div style="text-align: center;padding-top: 20px">
                                    <button type="file" id="written_request_of_bore_number" name="written_request_of_bore_number" value="{{old('written_request_of_bore_number') ?? ''}}" class="btn btn-primary waves-effect waves-light"> آپلود درخواست کتبی تعداد گمانه</button>
                                </div>
                            </div>
                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <div class="col-sm-12"  style="padding-top: 20px">
                                ...
                                <div style="text-align: center;padding-top: 20px">
                                    <button type="file" id="written_request_of_well_number" name="written_request_of_well_number" value="{{old('written_request_of_well_number') ?? ''}}" class="btn btn-primary waves-effect waves-light"> آپلود درخواست کتبی تعداد چاهک</button>
                                </div>
                            </div>
